...
class Popmovnetflix extends StatefulWidget{
  const Popmovnetflix({super.key, required this.popularMovie});
  final PopularMovie popularMovie;

  @override
  State<Popmovnetflix> createState() => _PopmovnetflixState();
}

class _PopmovnetflixState extends State<Popmovnetflix> {
   ...
   return  Scaffold(
      ...
      body: Stack(
        children: [
          ...
          Hero(
            tag: widget.popularMovie.title, // Unique tag for Hero animation
            child: Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: NetworkImage(
                    "https://image.tmdb.org/t/p/w500${widget.popularMovie.posterPath}",
                  ),
                  fit: BoxFit.cover,
                ),
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                     ...
                     ElevatedButton.icon(
                        onPressed: () {
                          favoritecontroller.addToFavorite(widget.popularMovie);
                        ...
                        icon: Obx((){
                         return Icon(favoritecontroller.isFavorite(widget.popularMovie)
                            ? Icons.favorite
