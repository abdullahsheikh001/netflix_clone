...
class Caroseldetailscreen extends StatefulWidget {
  const Caroseldetailscreen({super.key, required this.movie});
  final Movie movie;
...
class Caroselstate extends State<Caroseldetailscreen> {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          Hero(
            tag: widget.movie.title, // Unique tag for Hero animation
            child: Container(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      ElevatedButton.icon(
                        onPressed: () {
                          favoritecontroller.addToFavorite(widget.movie);
                        ...
                        icon: Obx((){
                         return Icon(favoritecontroller.isFavorite(widget.movie)
                            ? Icons.favorite
