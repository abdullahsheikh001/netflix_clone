...
class Upcomingdetail extends StatefulWidget{
  const Upcomingdetail({super.key, required this.upcoming});
  final Upcomingmodel upcoming;
   

  @override
  State<Upcomingdetail> createState() => _PopmovnetflixState();
}

class _PopmovnetflixState extends State<Upcomingdetail> {
   ...
   return  Scaffold(
      ...
      body: Stack(
        children: [
          ...
          Hero(
            tag: widget.upcoming.title, // Unique tag for Hero animation
            child: Container(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      ElevatedButton.icon(
                        onPressed: () {
                          favoritecontroller.addToFavorite(widget.upcoming);
                        ...
                        icon: Obx((){
                         return Icon(favoritecontroller.isFavorite(widget.upcoming)
                            ? Icons.favorite
